 ...
 */
function enterprise_health_process_page(&$variables) {
 ...
 */
function enterprise_health_menu_tree__main_menu(&$variables) {
 ...
 */
function enterprise_health_menu_link(array $variables) {
 ...
 * @ingroup themeable
 */
function enterprise_health_task_list($variables) {
...
function enterprise_health_preprocess_block(&$variables) {
  // Add classes to blocks for front page stripes.
  $variables['block_inner_class'] = '';
  if ($variables['is_front'] && $variables['block']->region == 'content') {
    $variables['classes_array'][] = 'block-row-'.$variables['zebra'];
    $variables['block_inner_class'] = 'container';
  }
}
