...
var sheet, xsSheet, smSheet, mdSheet, lgSheet;
...
sheet = gMakeSheet();
xsSheet = sheet;
smSheet = gMakeSheet('only screen and (min-width: 768px)');
mdSheet = gMakeSheet('only screen and (min-width: 992px)');
lgSheet = gMakeSheet('only screen and (min-width: 1200px)');
