/**
 * @file
 * Plugin for replacing filebrowser dialog with dialog from Drupal media module
 */
 ...
 (function($) {
  ...
  Drupal.settings.ckeditor.plugins['mediaBrowser'] = {
    /*
     * Traverse through the content definition and attach mediabrowser to elements with 'filebrowser' attribute.
     *
     * @param String
