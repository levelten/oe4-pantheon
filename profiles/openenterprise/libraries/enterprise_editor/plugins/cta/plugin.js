...
CKEDITOR.plugins.add( 'cta', {
	...
	init: function( editor ) {
		...
		// Register the cta widget.
		editor.widgets.add( 'cta', {
...
//					allowedContent: 'p br ul ol li strong em a[href,alt, role](btn, btn-primary, btn-default, btn-success, btn-info, btn-danger, btn-link, btn-lg, btn-sm, btn-xs)'
      ...
      '<div class="cta cta-rectangle">' +
        ...
        '<div class="content">' +
          '<p>This is a simple hero unit, a simple cta-style component for calling extra attention to featured content or information.</p>' +
          '<p><a href="#" class="btn btn-cta pull-right" role="button">Get it now!</a></p>' +
        '</div>' +
      '</div>',
			...
			// editor.lang.cta.* property. A string was used directly here to simplify this tutorial.
			button: 'Create a cta',
			...
			upcast: function( element ) {
				...
				// for all <div> elements with a "cta" class.
